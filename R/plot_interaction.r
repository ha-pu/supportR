...
plot_interaction.lmerMod <- plot_interaction.glmerMod <- function(model, iv, moderator, ci = 0.9, ...) {
  ...
  # draw plot ----
  out <- interplot::interplot(model, var1 = iv, var2 = moderator, ci = ci, hist = TRUE) +
